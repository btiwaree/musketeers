...
public class CBeanRolloverButton extends CGlassButton {
   ...
   public static CBeanRolloverButton GetOkButton (String strName, String strTooltip) {
      final CBeanRolloverButton buttonOk = new CBeanRolloverButton();
   ...
   public static CBeanRolloverButton GetCancelButton (final String strName, final String strTooltip) {
      final CBeanRolloverButton buttonCancel = new CBeanRolloverButton();
   ...
   public static CBeanRolloverButton GetRandomButton(final String strName, final String strTooltip) {
	      final CBeanRolloverButton buttonCancel = new CBeanRolloverButton();
   ...
   private static void setProperties (final CBeanRolloverButton button, final String strName, final String strTooltip) {
